...
import logging
import sys
import os  # For accepting and handling paths
import pandas as pd
...
if __name__ == "__main__":
    # Ensure that the script accepts the CSV file path as an argument
    #if len(sys.argv) < 2:
    #   logging.error("Please provide the CSV file path as an argument.")
    #   sys.exit(1)

    #csv_file = sys.argv[1]
    csv_file = '4import/05-11_new_driver_history.csv'
